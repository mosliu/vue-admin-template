<template>
  <div>
    <el-upload :show-file-list="false" :headers="myHeaders" :on-success="handleAvatarSuccess"
               :before-upload="beforeAvatarUpload" :action="getAvatarAction" class="avatar-uploader"
  ...
  methods: {
    handleAvatarSuccess(res, file) {
      ...
      if (res.status === 200 || res.code === 0) {
        ...
        this.$emit('getAvatar',process.env.VUE_APP_BASE_API + this.imageUrl)
      } else {
